import{_ as s,o as n,c as a,a as e}from"./app-ra6C9Im4.js";const t={},p=e(`<h2 id="项目内添加全局less变量-这样就不用手动的到每个文件里去-import" tabindex="-1"><a class="header-anchor" href="#项目内添加全局less变量-这样就不用手动的到每个文件里去-import" aria-hidden="true">#</a> 项目内添加全局less变量(这样就不用手动的到每个文件里去@import)</h2><p>环境 @vue/cli 5.0.0</p><p>安装插件</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>npm i style-resources-loader -D
