import{_ as n,o as s,c as a,a as e}from"./app-x4psNM6s.js";const p={},t=e(`<h1 id="python-基础知识" tabindex="-1"><a class="header-anchor" href="#python-基础知识" aria-hidden="true">#</a> Python 基础知识</h1><h2 id="数据类型" tabindex="-1"><a class="header-anchor" href="#数据类型" aria-hidden="true">#</a> 数据类型</h2><p>int,float,True,False,str,list,tuple,set,dict<br> Python 内置支持 复数，后缀 j 或 J 用于表示虚数（例如 3+5j ）</p><h3 id="数值" tabindex="-1"><a class="header-anchor" href="#数值" aria-hidden="true">#</a> 数值</h3><p>整数（如，2、4、20 ）的类型是 int，带小数（如，5.0、1.6 ）的类型是 float。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>counter <span class="token operator">=</span> <span class="token number">100</span>  <span class="token comment"># 整型变量</span>
