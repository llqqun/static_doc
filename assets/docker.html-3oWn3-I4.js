import{_ as e,o as d,c as i,a as n}from"./app-x4psNM6s.js";const a={},s=n(`<h1 id="docker" tabindex="-1"><a class="header-anchor" href="#docker" aria-hidden="true">#</a> DOCKER</h1><h2 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令" aria-hidden="true">#</a> 常用命令</h2><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>  run         通过镜像创建一个容器
  exec        在正在运行的容器中执行命令
