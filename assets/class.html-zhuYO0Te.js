import{_ as n,o as s,c as a,a as t}from"./app-1Fk5NupV.js";const p={},e=t(`<h1 id="javascript中的类" tabindex="-1"><a class="header-anchor" href="#javascript中的类" aria-hidden="true">#</a> JavaScript中的类</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">People</span> <span class="token punctuation">{</span>
