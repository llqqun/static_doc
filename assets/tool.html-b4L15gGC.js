import{_ as e,o as n,c as i,a}from"./app-EcLxh2yi.js";const d={},s=a(`<h1 id="工具的使用" tabindex="-1"><a class="header-anchor" href="#工具的使用" aria-hidden="true">#</a> 工具的使用</h1><h2 id="包管理器" tabindex="-1"><a class="header-anchor" href="#包管理器" aria-hidden="true">#</a> 包管理器</h2><h3 id="pip命令" tabindex="-1"><a class="header-anchor" href="#pip命令" aria-hidden="true">#</a> pip命令</h3><p>更换全局pip镜像源 配置文件路径</p><blockquote><p>Windows：C:\\Users\\Administrator\\AppData\\Roaming\\pip\\pip.ini Linux/macOS：~/.pip/pip.conf</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>pip config set global.index-url https://pypi.tuna.tsinghua.edu.cn/simple
